...
class TestSASkillAliasRepository:
    def test_get_by_skill_id(self, session):
        ...
        from infrastructure.database.models.skill_model import SkillModel, SkillAliasModel
    ...
    def test_resolve_name_skill_deleted(self, session):
        from infrastructure.database.sa_skill_alias_repository import SQLAlchemySkillAliasRepository
        from infrastructure.database.models.skill_model import SkillAliasModel
