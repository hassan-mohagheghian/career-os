...
export function CompanyEditDrawer({ companyId, onOpenChange }: CompanyEditDrawerProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      queryClient.invalidateQueries({ queryKey: [COMPANY_DETAIL_KEY, companyId] })
      onOpenChange(null)
    } catch {
          ...
          {!loading && detail && (
            <div className="space-y-3 px-4 py-4">
              ...
              <Field label="Industry">
                <Input value={industry} onChange={(e) => setIndustry(e.target.value)} placeholder="Software Development" />
              </Field>
              ...
              <div className="grid grid-cols-2 gap-3">
                <Field label="Company Size">
                  <Input value={companySize} onChange={(e) => setCompanySize(e.target.value)} placeholder="51-200" />
                </Field>
                <Field label="Company Type">
                  <Input value={companyType} onChange={(e) => setCompanyType(e.target.value)} placeholder="PRODUCT_COMPANY" />
                </Field>
              </div>
              <Field label="Website">
