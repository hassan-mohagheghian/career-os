    ...
    <Drawer open={open} onOpenChange={onOpenChange} placement="bottom">
        ...
        <div className="mx-auto w-full max-w-[560px] space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <Select
                value={f.scope}
                onValueChange={(v) => setF({ ...f, scope: v })}
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="COMPANY_PRODUCT">
                    Product Company
                  </SelectItem>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                value={f.priority}
                onChange={(e) =>
                  setF({ ...f, priority: parseInt(e.target.value) || 0 })
                }
                className="h-8 text-xs"
              />
            </div>
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              placeholder="How the rule matches candidates / companies"
      ...
      <DrawerFooter>
        ...
        <Button
          variant="default"
          size="sm"
          disabled={!f.key || !f.value}
          onClick={() => {
            if (f.key && f.value) onSave(f);
          }}
        >
