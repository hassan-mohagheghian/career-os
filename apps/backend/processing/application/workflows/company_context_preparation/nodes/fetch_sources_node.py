"""FetchSourcesNode — fetches all external company sources through the
ContentFetcher abstraction.

Supports multiple URLs and handles individual failures: one failed source must
not fail the entire workflow. Emits per-source child progress events and
