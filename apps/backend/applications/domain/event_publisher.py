"""ApplicationEventPublisher — the domain event port for the Applications context.
...
class ApplicationEventPublisher(ABC):
    """Port through which the Applications context publishes domain events."""
...
class InMemoryEventCollector(ApplicationEventPublisher):
        ...
        return [
            {
                ...
                "application_id": getattr(e, "application_id", None),
...
__all__ = ["ApplicationEventPublisher", "InMemoryEventCollector"]
