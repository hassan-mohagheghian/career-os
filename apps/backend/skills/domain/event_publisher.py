"""SkillEventPublisher — the domain event port for the Skills context.
...
class SkillEventPublisher(ABC):
    """Port through which the Skills context publishes domain events."""
...
class InMemoryEventCollector(SkillEventPublisher):
        ...
        return [
            {
                ...
                "skill_id": getattr(e, "skill_id", None),
                "skill_name": getattr(e, "skill_name", None),
                "name": getattr(e, "name", None),
                "categories": getattr(e, "categories", None),
            }
            for e in self._events
        ]


__all__ = ["SkillEventPublisher", "InMemoryEventCollector"]
