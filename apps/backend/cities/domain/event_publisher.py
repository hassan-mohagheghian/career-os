"""CityEventPublisher — the domain event port for the Cities context.
...
class CityEventPublisher(ABC):
    """Port through which the Cities context publishes domain events."""
...
class InMemoryEventCollector(CityEventPublisher):
...
__all__ = ["CityEventPublisher", "InMemoryEventCollector"]