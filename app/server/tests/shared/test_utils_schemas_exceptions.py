...
class TestSchemas:
    ...
    def test_common_success_response(self):
        from shared.application.schemas.common import SuccessResponse
        s = SuccessResponse(status="ok")
        assert s.status == "ok"

    def test_common_paginated_response(self):
        from shared.application.schemas.common import PaginatedResponse
...
class TestMappers:
    ...
    def test_dict_to_skill_model(self):
        from shared.infrastructure.database.mappers import dict_to_skill_model
    ...
    def test_company_intelligence_model_to_dict(self):
        from shared.infrastructure.database.mappers import company_intelligence_model_to_dict
    ...
    def test_dict_to_pending_job_model(self):
        from shared.infrastructure.database.mappers import dict_to_pending_job_model
    ...
    def test_dict_to_pending_company_model(self):
        from shared.infrastructure.database.mappers import dict_to_pending_company_model
        m = dict_to_pending_company_model({"input_text": "Google"})
        assert m.input_text == "Google"

    def test_career_insight_model_to_dict(self):
        from shared.infrastructure.database.mappers import career_insight_model_to_dict
    ...
    def test_career_insight_run_model_to_dict(self):
        from shared.infrastructure.database.mappers import career_insight_run_model_to_dict
    ...
    def test_resume_model_to_dict(self):
        from shared.infrastructure.database.mappers import resume_model_to_dict
...
class TestBackgroundTaskManager:
    ...
    async def test_run_task(self):
        from shared.infrastructure.workers.background import BackgroundTaskManager
    ...
    def test_get_task_manager_singleton(self):
        from shared.infrastructure.workers.background import get_task_manager
