...
class TestJobListV2API:
    ...
    def test_list_with_jobs(self, client, test_db):
        _create_job(test_db, num=1, title="Engineer One", company="Alpha Corp")
        _create_job(test_db, num=2, title="Engineer Two", company="Beta Inc")
    ...
    def test_pagination(self, client, test_db):
        for i in range(5):
            _create_job(test_db, num=i + 1, title=f"Job {i}")
    ...
    def test_search_by_title(self, client, test_db):
        _create_job(test_db, num=1, title="Senior Backend Engineer")
        _create_job(test_db, num=2, title="Junior Frontend Developer")
        _create_job(test_db, num=3, title="DevOps Engineer")
    ...
    def test_search_by_company(self, client, test_db):
        _create_job(test_db, num=1, title="Engineer", company="Google")
        _create_job(test_db, num=2, title="Engineer", company="Meta")
    ...
    def test_search_by_location(self, client, test_db):
        _create_job(test_db, num=1, title="Engineer", location="Berlin")
        _create_job(test_db, num=2, title="Engineer", location="Munich")
    ...
    def test_sort_by_created_at(self, client, test_db):
        _create_job(test_db, num=1, title="A")
        _create_job(test_db, num=2, title="B")
    ...
    def test_sort_by_score(self, client, test_db):
        _create_job(test_db, num=1, title="Low", overall_score=50)
        _create_job(test_db, num=2, title="High", overall_score=99)
    ...
    def test_filter_by_processing_status(self, client, test_db):
        _create_job(test_db, num=1, title="Queued", status="queued")
        _create_job(test_db, num=2, title="Completed", status="completed")
        _create_job(test_db, num=3, title="Imported", status="imported")
    ...
    def test_filter_by_remote(self, client, test_db):
        _create_job(test_db, num=1, title="Remote", work_type="Remote")
        _create_job(test_db, num=2, title="Onsite", work_type="On-site")
    ...
    def test_filter_by_visa(self, client, test_db):
        _create_job(test_db, num=1, title="Has Visa", visa="Yes")
        _create_job(test_db, num=2, title="No Visa", visa="")
    ...
    def test_filter_by_score_range(self, client, test_db):
        _create_job(test_db, num=1, title="Low", overall_score=30)
        _create_job(test_db, num=2, title="Mid", overall_score=60)
        _create_job(test_db, num=3, title="High", overall_score=95)
    ...
    def test_response_shape(self, client, test_db):
        _create_job(
            test_db, num=1, title="Engineer", company="Corp", location="Berlin",
    ...
    def test_not_found_filters_return_empty(self, client, test_db):
        _create_job(test_db, num=1, title="Engineer")
