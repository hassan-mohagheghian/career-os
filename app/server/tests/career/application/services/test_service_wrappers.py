...
class TestInsightsService:
    def _reset_singleton(self):
        import career.application.services.insights_service as mod
        mod._insights_service = None

    def test_singleton(self):
        self._reset_singleton()
        from career.application.services.insights_service import get_insights_service
        import career.application.services.insights_service as mod
    ...
    def test_not_running_initially(self):
        from career.application.services.insights_service import InsightsService
        svc = InsightsService()
    ...
    def test_generate_all_delegates(self):
        ...
        with patch.dict('sys.modules', {'career.application.services.insights': MagicMock(generate_all=mock_fn)}):
    ...
    def test_generate_section_delegates(self):
        ...
        with patch.dict('sys.modules', {'career.application.services.insights': MagicMock(generate_section=mock_fn)}):
    ...
    def test_generate_skills_intel_delegates(self):
        ...
        with patch.dict('sys.modules', {'career.application.services.insights': MagicMock(generate_skills_intel=mock_fn)}):
    ...
    def test_cancel_delegates(self):
        ...
        with patch.dict('sys.modules', {'career.application.services.insights': MagicMock(cancel_run=mock_cancel)}):
            result = svc.cancel()
    ...
    def test_get_progress_delegates(self):
        ...
        with patch.dict('sys.modules', {'career.application.services.insights': MagicMock(get_progress=mock_progress)}):
    ...
    def test_get_latest_delegates(self):
        ...
        with patch.dict('sys.modules', {'career.application.services.insights': MagicMock(get_latest=mock_latest)}):
    ...
    def test_get_runs_delegates(self):
        ...
        with patch.dict('sys.modules', {'career.application.services.insights': MagicMock(get_runs=mock_runs)}):
...
class TestSkillRoadmapService:
    def _reset_singleton(self):
        import skills.application.services.skill_roadmap_oop as mod
        mod._skill_roadmap_service = None

    def test_singleton(self):
        self._reset_singleton()
        from skills.application.services.skill_roadmap_oop import get_skill_roadmap_service
        import skills.application.services.skill_roadmap_oop as mod
    ...
    def test_get_source_for_operation(self):
        from skills.application.services.skill_roadmap_oop import SkillRoadmapService
    ...
    def test_generate_delegates(self):
        ...
        with patch.dict('sys.modules', {'skills.application.services.skill_roadmap_service': MagicMock(generate_roadmap=mock_fn)}):
    ...
    def test_extend_delegates(self):
        ...
        with patch.dict('sys.modules', {'skills.application.services.skill_roadmap_service': MagicMock(extend_roadmap=mock_fn)}):
    ...
    def test_finegrain_delegates(self):
        ...
        with patch.dict('sys.modules', {'skills.application.services.skill_roadmap_service': MagicMock(finegrain_roadmap=mock_fn)}):
