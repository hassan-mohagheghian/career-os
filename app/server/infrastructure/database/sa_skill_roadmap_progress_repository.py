...
from domain.repositories.skill_roadmap_progress_repository import ISkillRoadmapProgressRepository
from infrastructure.database.models.misc_models import SkillRoadmapProgressModel, SkillRoadmapModel
