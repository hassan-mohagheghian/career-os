...
from domain.repositories.skill_alias_repository import ISkillAliasRepository
from infrastructure.database.models.skill_model import SkillAliasModel, SkillModel
